...
//       try {
//         const res = await axios.get("http://localhost:5000/api/org/active", {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
//     <div key={i} className="px-4 py-3 hover:bg-gray-50 border-b cursor-pointer">
...
//   ))
// ) : (
//   <div className="px-4 py-3 text-gray-500 text-sm">No notifications yet</div>
// )}
...
//                     Welcome to AI Chat. You have <b>1,250 credits</b> to start with.
//                   </p>
//                 </div>

//                 {/* Notification 2 */}
//                 <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer">
//                   <p className="font-semibold text-gray-800">Feature Update</p>
//                   <p className="text-sm text-gray-500">12h ago</p>
//                   <p className="text-sm text-gray-600 mt-1">
